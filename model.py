...
class GarchModel:
    ...
    class GarchModel:
        ...
        self.model_directory = os.path.abspath(settings.model_directory)
    -------
    wrangle_data
    ...
    def wrangle_data(self,n_observations):
        ...
        if self.use_new_data:
            #Inestatiate an API class
            api=AlphaVantageAPI()
            # Get Dailly
            new_data=api.get_daily(ticker=self.ticker)
            #Insert data in to repo
    ...
    def fit(self,p,q):
        ...
        # Save AIC and BIC as new attributes
    ...
    def __clean_prediction(self,prediction):
        ...
        # Create date range
        prediction_dates = pd.bdate_range(start=start
    ...
    def predict_volatility(self,horizon):
        ...
        prediction = self.model.forecast(horizon=horizon,
    ...
    def dump(self):
        """Save model to self.model_directory with safe timestamp."""
    ...
    def load(self):
        ...
        # Handle possible `IndexError`
            ...
            raise Exception (f"No model trianed for '{self.ticker}'.")
